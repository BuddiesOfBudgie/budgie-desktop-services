...
namespace bd::BatchSystem {
    ...
    public:
        ...
        static Type fromString(const QString& str) {
            ...
            if (lower == QLatin1String("left")) return Left;
            if (lower == QLatin1String("right")) return Right;
            if (lower == QLatin1String("center")) return Center;
            if (lower == QLatin1String("none")) return NoHorizontalAnchor;
    ...
    public:
        ...
        static Type fromString(const QString& str) {
            ...
            if (lower == QLatin1String("none")) return NoVerticalAnchor;
